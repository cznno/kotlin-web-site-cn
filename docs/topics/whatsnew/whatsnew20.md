...
compile-time library path via the `compileDependencyFiles` [compilation parameter](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-dsl-reference.html#编译项参数).

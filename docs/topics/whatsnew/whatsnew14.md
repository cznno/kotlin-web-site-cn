...
[Kotlin 多平台](multiplatform-intro.md) reduces time spent writing and maintaining the same code for [different platforms](multiplatform-dsl-reference.md#目标) 
...
With the new hierarchical project structure support, you can share code among [several platforms](multiplatform-dsl-reference.md#目标)
...
This made it easy to [share code on all platforms](multiplatform-share-on-platforms.md#对所有平台共享代码), but it was
not so easy to [share between only some of the targets](multiplatform-share-on-platforms.md#对相似平台共享代码), 
...
about [sharing code in libraries](multiplatform-share-on-platforms.md#在库中共享代码).

...
[Kotlin 多平台](https://www.jetbrains.com/help/kotlin-multiplatform-dev/get-started.html) reduces time spent writing and maintaining the same code for [different platforms](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-dsl-reference.html#目标) 
...
With the new hierarchical project structure support, you can share code among [several platforms](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-dsl-reference.html#目标)
...
This made it easy to [share code on all platforms](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-share-on-platforms.html#对所有平台共享代码), but it was
not so easy to [share between only some of the targets](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-share-on-platforms.html#对相似平台共享代码), 
...
Now you can do this with the [hierarchical project structure support](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-share-on-platforms.html#对相似平台共享代码), which infers and adapts the API and language features 
...
about [sharing code in libraries](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-share-on-platforms.html#在库中共享代码).
...
[Learn how to change the default behavior](gradle-configure-project.md#对标准库的依赖).

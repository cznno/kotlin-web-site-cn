...
Kotlin/Native supports two build modes, [debug and release](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-build-native-binaries.html#声明二进制文件).
...
Using [`transitiveExport = true`](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-build-native-binaries.html#将依赖项导出到二进制文件) disables dead
...
Try to avoid unnecessary [module export](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-build-native-binaries.html#将依赖项导出到二进制文件).

...
This guide summarizes [incompatible changes](kotlin-evolution-principles.md#不兼容的变更) you might encounter while
...
and a Gradle version higher than 8.7, the plugin doesn't work. Instead, upgrade to [Kotlin 2.1.21](releases.md#版本发布详情)

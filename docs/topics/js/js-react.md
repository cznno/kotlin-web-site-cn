[//]: # (title: 使用 React 与 Kotlin/JS 构建 web 应用程序——教程)
...
1. Add the following definition to the `VideoList.kt` file:
   ...
   ```
   The [external](js-interop.md#external-修饰符) modifier tells the compiler that the interface's implementation is provided
